...
import static com.ecom.starshop.helper.Constant.FRAGMENT_CHANGE_PASSWORD;
 ...
 * ---------  */
public class ActivityShowFragment extends AppCompatActivity implements Listener.FragmentListener, Listener.FragmentChangeListener {
