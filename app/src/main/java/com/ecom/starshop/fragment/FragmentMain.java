...
import static com.ecom.starshop.helper.Constant.DIRECTION_LEFT;
import static com.ecom.starshop.helper.Constant.DIRECTION_RIGHT;

public class FragmentMain extends Fragment implements
        BottomNavigationView.OnNavigationItemSelectedListener{
    private static FragmentMain fragmentMain;

    public FragmentMain(Listener.FragmentListener fragmentListener) {
        // Required empty public constructor
        this.fragmentListener = fragmentListener;
    }

    public static FragmentMain getInstance( Listener.FragmentListener fragmentListener ){
